...
public class DataManager : Singleton<DataManager>
{
    ...
    public  DataManager()
    {
        this.DataPath = "D:/gd/ExtremeWorld/m_mmorpg/Src/Server/GameServer/GameServer/bin/Debug/Data/";
        Log.Info("DataManager -> DataManager()");
    }
    public void Load()
    {
        Log.Info("DataManager -> Load()");
    ...
    {
        Log.Info("DataManager ->IEnumerator Load()");
